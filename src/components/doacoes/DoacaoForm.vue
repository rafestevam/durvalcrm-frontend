  ...
  <form @submit.prevent="handleSubmit" class="space-y-6">
    <div>
      ...
      <select
        ...
        data-testid="doacao-form-associado-select"
      >
    ...
    <div>
      ...
      <div class="mt-1 relative rounded-md shadow-sm">
        ...
        <input
          ...
          placeholder="0,00"
          required
          data-testid="doacao-form-valor-input"
        />
      </div>
    </div>
    ...
    <div>
      ...
      <select
        ...
        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
        required
        data-testid="doacao-form-tipo-select"
      >
    ...
    <div>
      ...
      <textarea
        ...
        data-testid="doacao-form-descricao-textarea"
      />
    </div>
    ...
    <div class="flex justify-end space-x-3">
      <button
        ...
        data-testid="doacao-form-cancelar-button"
      >
        Cancelar
      </button>
      <button
        ...
        data-testid="doacao-form-submit-button"
      >
